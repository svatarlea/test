    ...
    public class admin_reports_content : ITestModule
    {
        ...
        void ITestModule.Run()
        {
            ...
            string AdminUsername, AdminPassword;
           	FormDataAdmin.GenerateAdminLogin(out AdminUsername, out AdminPassword);
            repo.WebDocumentWelcome.adminlogin.username.PressKeys(AdminUsername);
            repo.WebDocumentWelcome.adminlogin.password.PressKeys(AdminPassword);
